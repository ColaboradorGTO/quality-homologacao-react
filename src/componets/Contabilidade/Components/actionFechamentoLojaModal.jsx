...
export const ActionFechamentoLojaModal = ({ show, handleClose, dadosDetalheFechamento, dataPesquisa }) => {
  ...
  const dados = dadosDetalheFechamento.map((item, index) => {
    let totalDinheiroInformado = 0;
    if (item.VALORINFORMADO.DINHEIROAJUSTE > 0) {
      totalDinheiroInformado = item.VALORINFORMADO.DINHEIROAJUSTE;
    } else {
  ...
  const calcularTotalQuebra = () => {
    let total = 0;
    for (let venda of dados) {
      total += parseFloat(venda.totalQuebraCaixa);
    }
    return total;
  }
        ...
        <div style={{ padding: "10px" }} >
          ...
          <Modal.Body>
            <div className="panel">
              ...
              <div className="row col-sm-12 col-md-12 panel-hdr"
                style={{ margin: '0' }}
              >
                <div className="mr-2">

                  <h2 style={{ fontSize: '1.2rem', textAlign: 'center' }}>Fechamento dos Caixas da Loja</h2>
                </div>

                <div className="" style={{ display: 'flex', textAlign: 'center' }}>

                  <span style={{ fontSize: '1rem' }}>{`${dados[0]?.NOFANTASIA} - ${dataFormatada(dataPesquisa)}`}</span>
              ...
              <div className="panel-container">
                <div className="panel-content">
                  ...
                  {dadosDetalheFechamento[0]?.DEPOSITOS.length > 0 ? (
                    <Fragment>
                      <div style={{ marginTop: "20px" }}>
                        <h2 style={{ textAlign: "center", fontWeight: 700 }}>Relação de Depósitos</h2>
                      </div>
                      <div
                        style={{
                          display: "flex",
                      ...
                      >
                        <div className="col-sm-4 col-xl-2">
                          ...
                          <p style={{ fontSize: "16px", fontWeight: 600 }}>
                            {formatMoeda(dados[0]?.VRDEPOSITO)}
                          </p>
                        </div>
                        <div className="col-sm-4 col-xl-2">
                        ...
                        <div className="col-sm-4 col-xl-2">
                          ...
                          <p style={{ fontSize: "16px", fontWeight: 600 }}>
                            {parseFloat(dados[0]?.NUDOCDEPOSITO)}
                          </p>
                        </div>
                      </div>
                    </Fragment>
                    ...
                    <Fragment>
                      <div style={{ textAlign: "center", marginTop: "20px" }}>
                        ...
                        <p style={{ fontWeight: 500 }}>DEPÓSITO AINDA NÃO REALIZADO PELA LOJA</p>
                      </div>
                    </Fragment>
                  )}
                </div>
