...
export const ActionListaDetalhesVoucherEmitido = ({ dadosDetalheVoucherSelecionado, usuarioLogado }) => {
  ...
  const dados = dadosDetalheVoucherSelecionado.map((item, index) => {
  ...
  const colunasVouchers = [
    ...
    },
    {
      field: 'EMPORIGEM',
      header: 'Loja Emissor',
      body: row => <p style={{color: 'blue', fontWeight: 600, margin: '0px', width: '200px'}}>{row.EMPORIGEM}</p>,
      sortable: true,
    },
    {
      field: 'DSCAIXAORIGEM',
      header: 'Caixa Emissor',
      body: row => <p style={{color: 'blue', fontWeight: 600, margin: '0px', width: '100px'}}>{row.DSCAIXAORIGEM ? 'CAIXA WEB' : 'CAIXA WEB'}</p>,
      sortable: true,
    },
    {
      field: 'NOFUNCIONARIOLIBERACAOCRIACAO',
      header: 'Aut. Criação',
      body: row => <p style={{color: 'blue', fontWeight: 600, margin: '0px', width: '250px'}}>{row.NOFUNCIONARIOLIBERACAOCRIACAO}</p>,
      sortable: true,
    },
    {
      field: 'DTINVOUCHER',
      header: 'Data Emissão',
      body: row => <p style={{color: 'blue', fontWeight: 600, margin: '0px', width: '150px'}}>{dataHoraFormatada(row.DTINVOUCHER)}</p>,
      sortable: true,
    },
    {
      field: 'VRVOUCHER',
    ...
    },
    {
      ...
      body: row => <p style={{color: 'blue', fontWeight: 600, margin: '0px', width: '200px'}}>{row.EMPDESTINO}</p>,
      sortable: true,
    },
    {
    ...
    },
    {
      ...
      header: 'Aut. Consumo',
      body: row => <p style={{color: 'blue', fontWeight: 600, margin: '0px', width: '200px'}}>{row.NOFUNCIONARIOLIBERACAOCONSUMO}</p>,
      sortable: true,
    },
    {
      field: 'DTOUTVOUCHER',
      header: 'Data Recebido',
      body: row => <th style={{color: 'blue'}}>{dataHoraFormatada(row.DTOUTVOUCHER)}</th>,
      sortable: true,
    },
    {
      field: 'STSTATUS',
