...
export const useCadastrarCliente = ({ usuarioLogado, optionsModulos, handleClose }) => {
    ...
    const onSubmit = async () => {
        if(nomeClienteRazao == '') {
            Swal.fire({
                title: 'Atenção',
                text: 'O campo Nome/Razão Social é obrigatório.',
                icon: 'warning',
                customClass: {
                    container: 'custom-swal',
                }
        ...
        if(sobrenome == '') {
            Swal.fire({
                title: 'Atenção',
                text: 'O campo Sobrenome/Nome Fantasia é obrigatório.',
                icon: 'warning',
                customClass: {
                    container: 'custom-swal',
                }
        ...
        let IE = tipoIndicacaoIE == 2 ? 'ISENTO' : (IE || 'ISENTO');
        let IM = '';
        const putData = {
