...
export const ActionListaConsolidadoBanco = ({ 
  dadosConciliarBancoConsolidado,
  btnVisivel, 
  setBtnVisivel 
}) => {
  ...
  const colunasConciliarBancoConsolidado = [
    {
      ...
      header: 'Grupo',
      body: row => <p style={{ width: '160px', fontWeight: 600, margin: '0px' }}>{row.DSSUBGRUPOEMPRESARIAL}</p>,
      footer: 'Total',
      sortable: true
    },
    {
      field: 'TOTALDEPBB',
      header: 'BB',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPBB)}</th>,
    ...
    },
    {
      field: 'TOTALDEPITAU',
      header: 'Itaú',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPITAU)}</th>,
    ...
    },
    {
      field: 'TOTALDEPBRAD',
      header: 'Bradesco',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPBRAD)}</th>,
    ...
    },
    {
      field: 'TOTALDEPBRB',
      header: 'BRB',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPBRB)}</th>,
    ...
    },
    {
      field: 'TOTALDEPCX',
      header: 'Caixa',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPCX)}</th>,
    ...
    },
    {
      field: 'TOTALDEPSANT',
      header: 'Santander',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPSANT)}</th>,
    ...
    },
    {
      field: 'TOTALDEPTED',
      header: 'R. TED',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPTED)}</th>,
    ...
    },
    {
      field: 'TOTALDEPCXTES',
      header: 'CX. Tesoura',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPCXTES)}</th>,
    ...
    },
    {
      field: 'TOTALDEPCREDS',
      header: 'C.CredSystem',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPCREDS)}</th>,
    ...
    },
    {
      field: 'TOTALDEPDPIX',
      header: 'D.PIX',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPDPIX)}</th>,
    ...
    },
    {
      field: 'TOTALDEPDDIN',
      header: 'D. Dinheiro',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPDDIN)}</th>,
    ...
    },
    {
      field: 'TOTALDEPPROM',
      header: 'Prem. Prom',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPPROM)}</th>,
    ...
    },
    {
      ...
      header: 'Transp. Valor',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPTVALOR)}</th>,
    ...
    },
    {
      field: 'TOTALDEPDEVCX',
      header: 'D. Sobra CX',
      body: row => <th style={{ color: '' }}>{formatMoeda(row.TOTALDEPDEVCX)}</th>,
    ...
    },
    {
      ...
      body: row => <th style={{ color: '' }}>{formatMoeda(row.valorDepositadoBandeira)}</th>,
