...
import { useCadastrarAdiantamento } from "../hooks/useCadastrarAdiantamento";
...
export const Formulario = ({
  ...
  const {
    ...
    optionsEmpresas,
    onSubmit
  } = useCadastrarAdiantamento({ optionsModulos, usuarioLogado, handleClose });
