                ...
                <div className="form-group">
                    ...
                    <div className="row">
                        <div className="col-sm-6 col-md-6 col-xl-6">
                            ...
                            />
                            {errors.enderecoCliente && <span className="text-danger">{errors.enderecoCliente.message}</span>}
                        </div>
                        <div className="col-sm-6 col-md-6 col-xl-6">
                            <InputFieldModal
                                label={"Complemento"}
                            ...
                            />
                            {errors.complementoCliente && <span className="text-danger">{errors.complementoCliente.message}</span>}
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-sm-6 col-md-3 col-xl-3">
                            ...
                            />
                            {errors.bairroCliente && <span className="text-danger">{errors.bairroCliente.message}</span>}
                        </div>
                        ...
                        <div className="col-sm-6 col-md-3 col-xl-3">
                            ...
                            />
                            {errors.cidadeCliente && <span className="text-danger">{errors.cidadeCliente.message}</span>}
                        </div>
                        <div className="col-sm-6 col-md-3 col-xl-3">
                            <InputFieldModal
                                label={"CEP"}
                                ...
                                id={"cepCliente"}
                                value={cep}
                                onChangeModal={(e) => setCEP(e.value)}
                                {...register("cepCliente", { required: "Campo obrigatório Informe o CEP", })}
                            />
                            {errors.cepCliente && <span className="text-danger">{errors.cepCliente.message}</span>}
                        </div>
                        <div className="col-sm-6 col-md-3 col-xl-3">
                            <InputFieldModal
                                label={"UF"}
                            ...
                            />
                            {errors.ufCliente && <span className="text-danger">{errors.ufCliente.message}</span>}
                        </div>
