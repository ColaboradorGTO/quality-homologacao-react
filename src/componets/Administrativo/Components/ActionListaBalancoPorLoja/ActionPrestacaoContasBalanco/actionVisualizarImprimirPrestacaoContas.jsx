...
import { useConfirmarPrestacaoContas } from "./useConfirmarPrestacaoContas";

export const ActionVisualizarImprimirPrestacaoContas = ({
  show,
  handleClose,
      ...
      <Modal show={show} onHide={handleClose} size="xl" className="modal fade" tabIndex={-1} role="dialog" aria-hidden="true">
        <div style={{ padding: "10px" }}>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style={{ border: 'none', textAlign: 'end' }}>
                              <ButtonTypeModal
                                onClickButtonType={() => { }}
                                textButton={"Finalizar Balanço"}
                                cor={"success"}
                                style={{ display: dadosListaContasBalanco[0]?.listagem.STCONCLUIDO == 'False' ? 'block' : 'none' }}
                              />
                            </td>
                          </tr>
          ...
          <FooterModal
            ...
            onClickButtonFechar={handlePrint}
            corFechar={"warning"}

            ButtonTypeConfirmar={ButtonTypeModal}
            textButtonConfirmar={!visualizarImpressao ? "Visualizar Impressão" : "Visualizar Tabela"}
            onClickButtonConfirmar={() => { setVisualizarImpressao(!visualizarImpressao), setTabela(!tabela) }}
