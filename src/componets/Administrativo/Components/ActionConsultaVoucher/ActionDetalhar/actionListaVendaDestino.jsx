...
export const ActionListaVendaDestino = ({ dadosDetalheVoucher }) => {
    ...
    const colunasProdutosVendasDestino = [
        ...
        },
        {
            field: 'DSNOMEPRODUTO',
            header: 'Produto',
            body: row => <th style={{ color: 'blue' }}>{row.DSNOMEPRODUTO}</th>,
            sortable: true,
        },
        {
            field: 'QTDPRODUTO',
            header: 'Quantidade',
            body: row => <th style={{ color: 'blue' }}>{row.QTDPRODUTO}</th>,
            sortable: true,
        },
        {
            field: 'VRLIQUIDO',
