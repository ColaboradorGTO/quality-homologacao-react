...
export const ActionListaGerente = ({ 
  dadosGerente,
}) => {
  ...
  console.log(dadosGerente, "dados gerente")
  const dados = dadosGerente.data?.map((item, index) => {
    ...
    <Fragment>
      <div className="panel" >
        <div className="panel-hdr">
          {/* <h2>{`REGRAS PREMIAÇÕES: ${dadosGerente?.dsSubGrupo} - ${dadosGerente?.dataPesquisaInicio} a ${dadosGerente?.dataPesquisaFim}`}</h2> */}
          <h2>{`GERENTE`}</h2>
        </div>
