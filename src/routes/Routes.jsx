  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route path="/DashBoardComprasAdm" element={usuarioLogado ? <DashBoardComprasDM componentToShow={componentToShow} handleShowComponent={handleShowComponent}  /> : <Navigate to="/"/> } />
